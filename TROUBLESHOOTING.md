...
```
Fatal error in launcher: Unable to create process using '"C:\Users\redacted\Documents\GitHub\twitch-viewer\TwitchAdAvoider-lite-2\venv\Scripts\python.exe"  "C:\Users\redacted\Documents\GitHub\twitch-viewer\venv\Scripts\pip.exe" install -e . --quiet': The system cannot find the file specified.
```
