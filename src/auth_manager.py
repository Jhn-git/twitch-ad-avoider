...
class AuthManager:
    ...
    def _start_callback_server(self) -> bool:
        ...
        try:
            self.callback_server = HTTPServer(("localhost", 8080), AuthCallbackHandler)
        ...
        try:
            ...
            while self.callback_server:
                ...
                if hasattr(self.callback_server, 'auth_code') and self.callback_server.auth_code:
                    ...
                    self._exchange_code_for_token(self.callback_server.auth_code, self.callback_server.auth_state)
                    break
                elif hasattr(self.callback_server, 'auth_error') and self.callback_server.auth_error:
                    # Error occurred
