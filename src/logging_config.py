...
def configure_logging_from_config(config_manager: "ConfigManager") -> logging.Logger:
    """
    ...
    return setup_logging(level=log_level, log_to_file=log_to_file, enable_debug=debug_enabled)


def reconfigure_logging_from_config(config_manager: "ConfigManager") -> logging.Logger:
    """
    ...
    return reconfigure_logging(level=log_level, log_to_file=log_to_file, enable_debug=debug_enabled)
