...
from src.validators import (
    validate_channel_name, sanitize_player_args, validate_file_path,
    validate_numeric_range, validate_quality_option, validate_player_choice,
    validate_log_level, sanitize_string_input
)
...
class TestChannelNameValidation(unittest.TestCase):
    ...
    def test_valid_channel_names(self):
        ...
        valid_channels = [
            'ninja', 'shroud', 'test_channel', 'test123',
            'user_name_123', 'streamer2024', 'gaming_pro'
        ]
    ...
    def test_invalid_characters(self):
        ...
        invalid_channels = [
            'test$channel', 'user@name', 'stream#er', 
            'channel!', 'user%name', 'test space',
            'user-name', 'stream.er', 'test+name',
            'channel=name', 'user(name)', 'test[name]'
        ]
