...
def sample_chat_messages():
    ...
    """
    return [
        '@badge-info=;badges=;color=#FF0000;display-name=TestUser;emotes=;id=abc-123;mod=0;room-id=12345;subscriber=0;tmi-sent-ts=1234567890;turbo=0;user-id=67890;user-type= :testuser!testuser@testuser.tmi.twitch.tv PRIVMSG #testchannel :Hello, World!',
