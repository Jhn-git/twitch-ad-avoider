...
try {
    ...
    if (-not (Test-PythonInstallation)) { 
        Write-Error "Python is required. Please install Python 3.10 through 3.13 from https://python.org"
        Write-Info "This project requires Python >=3.10,<3.14 as specified in pyproject.toml"
