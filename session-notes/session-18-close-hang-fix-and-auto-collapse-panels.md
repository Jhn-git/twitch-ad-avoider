...
2. **The old ~27GB `C:\Users\redacted\Desktop\Jhn Apps\jhn-twitch-viewer.previous\` folder from session 17 is still sitting on disk**, unchanged (confirmed still present, still ~27GB). The user already said back in session 17 they don't care if it's deleted — it's just never actually been deleted. Safe to delete whenever convenient.
